...
export default function Home() {
  ...
  const createLearningGrowthData = () => {
    ...
    const dataMap = new Map(
      dashboardData.learningGrowth.data.map((item) => [item.month, item.percentage])
    );
  ...
  return (
    <div className={`min-h-screen bg-gray-50 px-4 sm:px-6 md:px-8 py-6 ${poppins.className}`}>
      {/* Header */}
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        <div className="flex-1 p-4 rounded-xl flex gap-2"
          style={{
            background:
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {[
          ...
          {
            title: "Projects:",
            description: `${dashboardData.activities.projects.pending} Project${dashboardData.activities.projects.pending !== 1 ? "s" : ""} Pending – '${dashboardData.activities.projects.nextProject}'`,
          ...
          <div key={idx} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600 text-sm mb-4 break-words line-clamp-2">{card.description}</p>
            <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Weekly Progress */}
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Progress from last week</h2>
            <div className="space-y-4">
