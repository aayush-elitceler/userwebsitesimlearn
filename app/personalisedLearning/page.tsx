...
function PersonalisedLearningPage() {
  ...
  const handleImproveClick = (subject: string) => {
    router.push(`/personalisedLearning/improve/${subject}`)
  }
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Visualize your skill growth.</p>
              </CardHeader>
              <CardContent className="space-y-6 bg-[#FF9E2714] p-4 rounded-md">
                {/* Grammar - Tenses */}
                <div className="space-y-2 ">
                  <div className="flex justify-between items-center">
                    <h3 className="font-medium text-gray-900">Grammar - Tenses</h3>
                    <span className="text-sm text-orange-600 font-medium">46% mastered</span>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <h3 className="font-medium text-gray-900">Science - Biology</h3>
                    <span className="text-sm text-orange-600 font-medium">72% mastered</span>
                  </div>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Complete your daily learning goal.</p>
              </CardHeader>
              <CardContent>
               
                
                <div className="space-y-3  bg-[#FF9E2714] p-4 rounded-md">
                  <h3 className="font-medium text-gray-900">Practice your Maths - Tables</h3>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Custom designed for your level.</p>
              </CardHeader>
              <CardContent>
                <Button 
                  className="cursor-pointer w-full point-ask-gradient hover:bg-orange-600 text-white"
                  onClick={() => router.push('/personalisedLearning/practice-sets')}
                >
                  Create practice set
                </Button>
              </CardContent>
