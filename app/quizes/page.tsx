  ...
  return (
    ...
    >
      <div className="flex-1">
        ...
        {previous ? (
          <button className="bg-black text-white rounded-full px-6 py-2 font-semibold mt-2 shadow hover:bg-[#333] transition">
            View answers
          </button>
        ) : (
          <button
  ...
  return (
    <div className="min-h-screen w-full px-4 md:px-12 py-8 bg-gradient-to-br from-[#181c24] to-[#1a2a22]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-row flex-nowrap gap-8 overflow-x-auto scrollbar-hide pb-4">
          {loading ? (
            <div className="text-white">Loading...</div>
          ) : previous.length === 0 ? (
