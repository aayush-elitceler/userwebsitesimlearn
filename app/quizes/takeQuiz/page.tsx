...
function QuizCard({
  ...
  return (
    <div className="flex flex-row bg-white border border-[#DEDEDE] items-center 
                    ...
                    sm:w-[500px] sm:h-[220px] sm:p-5
                    md:w-[420px] md:h-[220px] md:p-4
                    lg:w-[480px] lg:h-[240px] lg:p-5
                    xl:w-[520px] xl:h-[260px] xl:p-6
                    2xl:w-[588px] 2xl:h-[280px] 2xl:p-6">
      <div className="flex-1 min-w-0 flex flex-col justify-between h-full overflow-hidden">
        ...
        <div className="mt-auto pt-1">
          {previous ? (
            <button
              className="bg-gradient-to-r from-[#FFB31F] to-[#FF4949] text-white rounded-lg px-3 sm:px-4 lg:px-5 py-2.5 sm:py-2 font-semibold shadow hover:opacity-90 transition-opacity text-xs sm:text-sm whitespace-nowrap"
    ...
    <div className="min-h-screen w-full px-4 md:px-8 lg:px-12 py-8 bg-gray-100">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            className="fixed top-6 right-6 cursor-pointer z-50 flex items-center gap-2 bg-gradient-to-r from-[#FFB31F] to-[#FF4949] hover:opacity-90 transition-opacity text-white font-semibold px-5 py-3 rounded-lg shadow"
