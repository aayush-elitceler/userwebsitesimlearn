    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-3">
          <button 
            onClick={onNewChat}
            className="w-full rounded-md px-4 py-3 bg-primary/10 border border-primary text-primary hover:bg-primary/20 transition-all duration-150 flex items-center gap-3 justify-center"
          >
            ...
            <div className="space-y-3">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-primary rounded-md focus:outline-none focus:ring-2 focus:ring-primary/50"
                  autoFocus
                />
                <button
