              ...
              <nav className="flex flex-col flex-1 space-y-2 mt-4 px-4 overflow-y-auto scrollbar-hide pb-4">
                ...
                <div className="mb-2">
                  <div className="relative">
                    ...
                    >
                      <span className="flex items-center gap-3">
                        <Image src={quizWhite} alt="Quiz" width={20} height={20} className="h-5 w-5 flex-shrink-0" />
                    ...
                    <div className="ml-6 mt-3 flex flex-col gap-2">
                      {quizSubRoutes.map((sub) => {
                        ...
                        return (
                          ...
                          >
                            <Image src={sub.icon} alt={sub.label} width={20} height={20} className="h-5 w-5 flex-shrink-0" />
                            <span>{sub.label}</span>
                          </Link>
                        );
                      })}
                ...
                {/* Other menu items */}
                {data.items.filter(item => item.title !== "Take a Quiz" && item.title !== "Generate Quiz").slice(2).map((item, index) => {
